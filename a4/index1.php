...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
  ...
  <nav class="navbar navbar-expand-md bg-light navbar-light sticky-top"
    style="font: 30px Monospace; font-weight: bold;">
  ...
  <main>
    ...
    <div class="container"><p style="text-align: center; font-size: 25px;">Please choose a movie from now showing to see more details</p></div>
        ...
        <div id="sypnosis">
          <table class="table table-sm table-warning table-borderless" id="hotmovie">
            <tr>
              ...
              <th>
                ...
                <div class="embed-responsive embed-responsive-16by9" id="trailer" style="align-content:center;">
                  <iframe width="100%" height="100%" src="https://www.youtube.com/embed/TcMBFSGVi1c" frameborder="0"
            ...
            <tr>
              ...
              <td>
                <div><input type="button" value="WED" onclick="movieWED(); nondiscount()">
                  <a href="#bookingform"><input type="button" value="21:00" onclick="movieT21();"></a></div>
                <div><input type="button" value="THU" onclick="movieTHU(); nondiscount()">
                  <a href="#bookingform"><input type="button" value="21:00" onclick="movieT21();"></a></div>
                <div><input type="button" value="FRI" onclick="movieFRI(); nondiscount()">
                  <a href="#bookingform"><input type="button" value="21:00" onclick="movieT21();"></a></div>
                <div><input type="button" value="SAT" onclick="movieSAT(); nondiscount()">
                  <a href="#bookingform"><input type="button" value="12:00" onclick="movieT12();"></a></div>
                <div><input type="button" value="SUN" onclick="movieSUN(); nondiscount()">
                  <a href="#bookingform"><input type="button" value="12:00" onclick="movieT12();"></a></div>
              </td>
            </tr>
          </table>
          ...
          <table class="table table-sm table-warning table-borderless" id="hotmovie">
            <tr>
              ...
              <th>
                ...
                <br>
                <div class="embed-responsive embed-responsive-16by9" id="trailer" style="align-content:center;">
                  <iframe width="1519" height="562" src="https://www.youtube.com/embed/uoDBvGF9pPU" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
                </div>
            </tr>
            ...
            <tr>
              <th style="font-size: 20px;">Make a booking:</th>
              <td>
                <div><input type="button" value="MON" onclick="movieMON(); nondiscount()">
                  <a href="#bookingform"><input type="button" value="18:00" onclick="movieT18();"></a></div>
                <div><input type="button" value="TUE" onclick="movieTUE(); nondiscount()">
                  <a href="#bookingform"><input type="button" value="18:00" onclick="movieT18();"></a></div>
                <div><input type="button" value="SAT" onclick="movieSAT(); nondiscount()">
                  <a href="#bookingform"><input type="button" value="15:00" onclick="movieT15();"></a></div>
                <div><input type="button" value="SUN" onclick="movieSUN(); nondiscount()">
                  <a href="#bookingform"><input type="button" value="15:00" onclick="movieT15();"></a></div>
              </td>
            </tr>
          ...
          <table class="table table-sm table-warning table-borderless" id="hotmovie">
            <tr>
              ...
              <th>
                ...
                <br>
                <div class="embed-responsive embed-responsive-16by9" id="trailer" style="align-content:center;">
                  <iframe width="1519" height="562" src="https://www.youtube.com/embed/7NiYVoqBt-8" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
                </div>
            </tr>
            ...
            <tr>
              <th style="font-size: 20px;">Make a booking:</th>
              <td>
                <div><input type="button" value="MON" onclick="movieMON(); discount()">
                  <a href="#bookingform"><input type="button" value="12:00" onclick="movieT12();"></a></div>
                <div><input type="button" value="TUE" onclick="movieTUE(); discount()">
                  <a href="#bookingform"><input type="button" value="12:00" onclick="movieT12();"></a></div>
                <div><input type="button" value="WED" onclick="movieWED(); nondiscount()">
                  <a href="#bookingform"><input type="button" value="18:00" onclick="movieT18();"></a></div>
                <div><input type="button" value="THU" onclick="movieTHU(); nondiscount()">
          ...
          <table class="table table-sm table-warning table-borderless" id="hotmovie">
            <tr>
              ...
              <th>
                ...
                <br>
                <div class="embed-responsive embed-responsive-16by9" id="trailer" style="align-content:center;">
                  <iframe width="1519" height="562" src="https://www.youtube.com/embed/4HmN9r1Fcr8" frameborder="0"
                    allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture"
                    allowfullscreen></iframe>
                </div>
            </tr>
            ...
            <tr>
              <th style="font-size: 20px;">Make a booking:</th>
              <td>
                <div><input type="button" value="WED" onclick="movieWED(); discount()">
                  <a href="#bookingform"><input type="button" value="12:00" onclick="movieT12();"></a></div>
                <div><input type="button" value="THU" onclick="movieTHU(); discount()">
                  <a href="#bookingform"><input type="button" value="12:00" onclick="movieT12();"></a></div>
                <div><input type="button" value="FRI" onclick="movieFRI(); discount()">
                  <a href="#bookingform"><input type="button" value="12:00" onclick="movieT12();"></a></div>
                <div><input type="button" value="SAT" onclick="movieSAT(); nondiscount()">
                  <a href="#bookingform"><input type="button" value="21:00" onclick="movieT21();"></a></div>
                <div><input type="button" value="SUN" onclick="movieSUN(); nondiscount()">
    ...
    <div style="background-color: blanchedalmond" class="container">
      <label for="movietitle" id="demo" style="font-size: 30px;">Movie Title - </label>
      <input type="hidden" name="movie[id]" id="movie-id">
      <label for="movieday" id="demo1" style="font-size: 30px;">Movie Day - </label>
      <input type="hidden" name="movie[day]" id="movie-day">
      <label for="moviehour" id="demo2" style="font-size: 30px;">Movie Hour</label>
      <input type="hidden" name="movie[hour]" id="movie-hour">
      <div class="row">
        <div class="col-md-6">
          <form action="receipt.php" method="GET">
            <fieldset>
              <legend style="text-align: center;">Standard</legend>
          ...
          <form action="receipt.php" method="GET">
            <fieldset>
              <legend style="text-align: center;">First Class</legend>
              <label for="adults">Adults</label>
            ...
            <span id='total' name="total" style="font-size:30px;">Total: </span><br>
          </form>
        </div>
        <div style="text-align: center; font-size: larger;" class="col-md-6">
          Name <input type="text" name="cust[name]" id="name" pattern="^[a-zA-Z\-.,' ]{1,100}$" placeholder="Nhat Nguyen" required><br><br>
          Email <input type="text" name="cust[email]" id="email" pattern="^[a-zA-Z0-9\-.,'@ ]{1,100}$" placeholder="s3765963@gmail.com" required><br><br>
          Mobile <input type="tel" name="cust[mobile]" id="mobile" pattern="^(\(04\)|04|\+614)[ ]?\d{4}[ ]?\d{4}$" placeholder="(04)/04/+614 xxxx xxxx"
            required><br><br>
          Credit Card <input type="text" name="cust[card]" id="card" minlength="14" maxlength="19"
            pattern="^\d{4}[ ]?\d{4}[ ]?\d{4}[ ]?\d{4}$" placeholder="xxxx xxxx xxxx xxxx" required><br><br>
          Expiry
          <select name="cust[expiryYear]" id="Year" required>
          ...
          <select name="cust[expiryMonth]" id="Month" required>
    ...
    <article id='Website Under Construction' style="text-align: center;">
      ...
      <img src='https://cdn.pixabay.com/photo/2017/06/20/08/12/maintenance-2422173_1280.png' style="width: 600px;"
